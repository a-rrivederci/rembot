...
#define HORIZONTAL_INTERRUPT_PIN 3
#define LEFT_INTERRUPT_PIN 2 // Can only use 2 and 3 for Uno ISR
#define LED_PIN 13
...
void setup() {
    ...
    attachInterrupt(digitalPinToInterrupt(LEFT_INTERRUPT_PIN), stopHorizontalMotor, RISING);
}
